CREATE USER 'beatriz'@'%' IDENTIFIED BY 'computacao@raiz';
GRANT Event ON *.* TO 'beatriz'@'%';
GRANT Process ON *.* TO 'beatriz'@'%';
GRANT Reload ON *.* TO 'beatriz'@'%';
GRANT Show databases ON *.* TO 'beatriz'@'%';
GRANT Create tablespace ON *.* TO 'beatriz'@'%';
GRANT Create database  TO ‘beatriz’@’%’;
GRANT Create table TO ‘beatriz’@’%’;
GRANT Update ON *.* TO ‘beatriz’@’%’;
GRANT Insert ON *.* TO ‘beatriz’@’%’;
GRANT File ON *.* TO 'beatriz'@'%';
CREATE DATABASE uvv;
grant all on uvv.* to 'beatriz'@'%';
\q
mysql -u beatriz -p
computacao@raiz
use uvv;
